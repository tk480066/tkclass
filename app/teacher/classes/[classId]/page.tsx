...
import { Archive, ArrowRight, BookOpenCheck, ClipboardList, Layers3, UsersRound } from "lucide-react";
...
export default async function TeacherClassPage({ params }: { params: Promise<{ classId: string }> }) {
  ...
  const [classRow, roster, curriculum, assignments] = await Promise.all([
